    ...
    >
      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row justify-between gap-16 lg:gap-8 mt-12">
        ...
        <div className="w-full lg:w-2/5 flex flex-col justify-center items-start lg:items-end gap-5">
          ...
          <SlideUp delay={0.6}>
            <a href="https://drive.google.com/file/d/141iC4WpvLZfClqWFB2zGfLiSnq3BJNvL/view?usp=sharing" target="_blank" className="flex items-center justify-between gap-6 px-6 py-3 rounded-full border border-gray-400 hover:bg-[#dcdcd7] transition-colors cursor-pointer w-48 group">
